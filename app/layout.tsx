  ...
  return (
    <html lang="en">
      <body className={layoutClasses}>
        ...
        {children}
        <footer className="bg-pink-600 min-h-36 grow-0 p-8 md:px-24">
          <div className="text-sm">
            ...
            <br />
            <sup>[2]</sup> The LAD Calculator is only meant for reference purposes, it doesn't hold any legal authority against the actual compensation presented by PR1MA.
          </div>
        </footer>
      </body>
    </html>
